                    ...
                    <div>
                        <div className='grid grid-cols-3 justify-between space-x-[10px]' >
                            ...
                            <div className='smartbg px-[40px] pt-[40px] '>
                                ...
                                <div className='text-[24px] leading-[32px] text-[#fff] w-[95%] mt-[14px] '>Start with the Basic Plan for an entry into collective savings. Begin your journey to financial goals and benefit from group savings power.</div>
                                <hr className='w-[90%] my-[28px] bg-[#E7EBFF] ' />
                                <div className='flex'>
                                    <Image src={Check} alt='checks' className='mr-[16px]' />
