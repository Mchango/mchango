      ...
      <div className="lg:max-w-7xl w-full">
        <div className="flex w-[90%] items-center justify-between mx-auto pt-[26px]   ">
          ...
          <div className=" hidden sm:flex flex-row items-center gap-2 sm:gap-5 w-[fit-content]">
            ...
            <button className="border-[1px] fon-satoshi font-semibold border-[#008080] w-[fit-content]  rounded-[15px] text-[#FFFFFF] py-2 px-4 text-[14px] sm:text-[18px] tracking-[0.8px] hover:scale-110 active:scale-100px transition-all duration-200 hover:border-purple-400 hover:bg-[#008080] ">
              Get Started
            </button>
          </div>
        </div>
