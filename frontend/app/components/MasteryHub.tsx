  ...
  return (
    <div className="flex flex-col sm:flex-row lg:flex-col justify-center -mt-[100px] mb-[50px] w-full relative">
      <div className=" padding-x relative flex flex-col gap-5 lg:absolute  lg:left-0 sm:z-50">
        ...
        <p className="text-[18px] font-work font-medium -tracking-[0.32p] leading-[32px] my-[12px] sm:my-[15px]  w-[390px]  bg-clip-text text-transparent bg-gradient-to-b from-neutral-200 to-neutral-500   ">
