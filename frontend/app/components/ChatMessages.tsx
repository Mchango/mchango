          ...
          <div className="w-full  ">
            ...
            <div className="my-[47px] ">
              <div className="relative w-[373px] ">
                ...
                <input
                  className="bg-[#fff] border-[1px] text-[16px]  w-[373px] h-[48px] text-[#171C1B] pl-[52px] mx-auto rounded-[31px] outline outline-none "
            ...
            <div className="">
              <div className="chatcard text-[#fff] py-[39px] font-bold px-[31px] w-[371px]  ">
                <div className=" text-[24px] leading-[24px] font-bold tracking-[0.5px] mb-[12px] ">
                  {token.chat1}
                </div>
                <div className="text-[15px] leading-[20px] font-bold tracking-[0.3px] my-[16.5px] ">
                  {token.chat1time}
                </div>
                <div className="flex justify-between ">
                  <div className="flex">
                    <Image src={peep} alt="svg" className="" />
                    <div className="text-[10px] leading-[15px] font-bold text-[#fff] my-auto ml-[4px] ">
                      {token.chat1members}
                    </div>
                  </div>
                ...
                <div className="flex mt-[12px] ">
                  <Image src={peep} alt="svg" className="" />
                  <div className="text-[10px] leading-[15px] font-bold text-[#fff] my-auto ml-[4px] ">
                    Total Contribution: {token.chat1totalcont}
                  </div>
                </div>
              </div>
            </div>
            <div className="mx-auto text-[#FFFFFF] ">
              <div className="w-[308px] mt-[32px] mx-auto ">
                <div className="text-[24px] leading-[24px] tracking-[0.5px] ">
                  {token.chat2}
                </div>
                <div className="text-[15px] leading-[20px] tracking-[0.3px] my-[12px] ">
                  {token.chat1time}
                </div>
                <div className="flex justify-between my-[12px] ">
                  ...
                  <div className="w-[24px] h-[24px] rounded-[50%] bg-[#FD0D0099] text-[#fff] flex justify-center ">
                    3
                  </div>
                </div>
              ...
              <div className="w-[308px] mt-[32px] mx-auto ">
                ...
                <div className="flex mt-[12px] mb-[25px] ">
                  <Image src={peep} alt="svg" className="" />
                  <div className="text-[10px] leading-[15px] font-bold text-[#fff] my-auto ml-[4px] ">
                    Total Contribution: {token.chat3totalcont}
                  </div>
                </div>
                <hr className="bg-[#DDDDDD]" />
              </div>
              <div className="w-[308px] mt-[32px] mx-auto ">
                ...
                <div className="flex mt-[12px] mb-[25px] ">
                  <Image src={peep} alt="svg" className="" />
                  <div className="text-[10px] leading-[15px] font-bold text-[#fff] my-auto ml-[4px] ">
                    Total Contribution: {token.chat4totalcont}
                  </div>
                </div>
              </div>
            </div>
