    ...
    <div className='mx-auto'>
        ...
        <form className='w-[61%] mx-auto '>
            ...
            <div className='flex flex-col mb-[39px]'>
                ...
                <input className='mt-[17px] opacity-[0.8] rounded-[20px] text-[20px] font-semibold tracking-[0.1px] leading-[24px] text-[#000000] pl-[34px] py-[23px] w-[507px] outline outline-none ' placeholder='+407'/>
            </div>
            <div className='flex justify-center mb-[100px]'>
            <button className='signupbtn text-[16px] tracking-[0.8px] text-[#fff] w-[165px] h-[58px] mx-auto cursor-pointer '>
            Sign Up
            </button>
            </div>
        </form>
