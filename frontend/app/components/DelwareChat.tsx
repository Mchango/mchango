    ...
    <>
      {tokens.map((token, index) => (
        <div className="text-[#FFFFFF]" key={index}>
          <div className="w-full mx-auto mb-[25px] text-[11px] leading-[16px] text-[#717171] text-center ">
            {token.delwaretime}
          </div>
          <div className="flex">
            ...
            <div className="ml-[12px] ">
              <div className="flex">
                <div className="text-[16px] leading-[22px] font-extrabold ">
                  {token.delmemb1name}
                </div>
                <div className="text-[#717171] text-[11px] leading-[16px] my-auto ml-[5px] ">
                  {token.delmsgtime1}
                </div>
              </div>
              <div className="text-[15px] leading-[24px] font-light lg:w-[564px] ">
                {token.delchat1}
              </div>
            </div>
          </div>
          ...
          <div>
            <input
              ...
              className="w-[605px] h-[40px] rounded-[20px] pl-[8px] text-[#171C1B] "
            />
          </div>
        </div>
      ))}
