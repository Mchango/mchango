            ...
            <div className="ml-[64px]">
              <div className="grid grid-cols-2 ">
                <div className="grpcard1 pl-[19px] pt-[12px] pr-[16px] mb-[55px] ">
                  ...
                  <div className="text-[26px] font-extrabold leading-[31.2px] text-[#fff] mb-[6px] ">
                    {token.nameofgrp}
                  </div>
                  <div className="text-[12px] font-semibold leading-[13.2px] mb-[12px] text-[#fff] ">
                    {token.grpdate}
                  </div>
                  <div className="grid grid-cols-4">
                    <div className="w-[91px] ">
                      <Image src={locate} alt="png" className="" />
                      <div className="text-[14px] font-bold text-[#fff] mt-[5px] mb-[8px] ">
                        Group Admin Address
                      </div>
                      <div className="text-[#00FFFF] text-[12px] font-semibold ">
                        {token.grpether}
                      </div>
                    </div>
                    <div className="w-[91px] ">
                  ...
                  <div className="mx-auto w-full flex justify-center mt-[14px] mb-[34px] ">
                    <button className="grpbtnn text-[20px] mx-auto font-bold leading-[24px] tracking-[0.1px] text-[#00000] w-[343px] h-[52px] ">
                      View Group
                    </button>
                  </div>
                </div>
