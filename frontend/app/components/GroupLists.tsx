            ...
            <div key={index} className='flex justify-center '>
              <div className='w-full mt-[34px]'>
                <div className='ml-[64px]'>
                  <div className='grid grid-cols-2 space-x-[35px] '>
                    <div className='grpcard1 pl-[19px] pt-[12px] pr-[16px] '>
                    ...
                    <div className='mx-auto w-full flex justify-center mt-[14px] mb-[25px] '>
